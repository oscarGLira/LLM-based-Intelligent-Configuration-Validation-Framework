...
bf = Session(host="192.168.56.114")
...
def snapshot_init():
    try:
        ...
        SNAPSHOT_NAME = "4router-snapshot"

        # Specify the path to the snapshot directory
        snapshot_path = "/home/user/MV_framework/snapshot"  # Replace with the actual path to your snapshot
...
if __name__ == '__main__':
    snapshot_init()
    app.run(host='192.168.56.114', port=5000)
